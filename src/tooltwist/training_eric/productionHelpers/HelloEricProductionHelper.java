package tooltwist.training_eric.productionHelpers;
...
public class HelloEricProductionHelper extends WbdProductionHelper
{
	...
	public HelloEricProductionHelper(Properties prop)
	{
		super(prop);
	}
