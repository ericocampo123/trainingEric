package tooltwist.training_eric.widgets;
...
import tooltwist.training_eric.productionHelpers.HelloEricProductionHelper;
 ...
 * Hello Word Eric
 */
public class HelloEricWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "helloEric_preview.html";
	private static final String SNIPPET_DESIGN = "helloEric_design.html";
	private static final String SNIPPET_PRODUCTION = "helloEric_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator,instance, "helloEric_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance,"helloEric_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, HelloEricProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(HelloEricProductionHelper.class.getName()));
			}
		}
